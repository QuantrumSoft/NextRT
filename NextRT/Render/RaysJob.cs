    ...
    public class RaysJob : ThreadJob
    {
        ...
        public override void Update()
        {
            ...
            for (int i=rh.RayStart;i<rh.RayStart+rh.RayNum;i++)
            {
                ...
                OpenTK.Vector3 fv = -Cam.Transform(rh.aX[aa],rh.aY[aa],620);
                RayData[ai + 3] = fv.X;   ;// cp.X+fv.X;
                RayData[ai + 4] = fv.Y;
                RayData[ai + 5] =  fv.Z;// cp.Z+fv.Z;
